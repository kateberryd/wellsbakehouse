...
<html>
            ...
            <div class="modal-content">
               ...
               <div class="container">
                  <div class="cart-modal col-md-8">
                        ...
                        <div class="portfolio por-1 col-md-12 row">
                           <div class="por-img">
                              <div class="b-img">
                                 ...
                                 <img src="{{asset('/upload/images/menu_item_icon/'.$ai->menu_image)}}" class="cartth"> 
                                 @endif
                                 @endforeach
                              </div>
                           </div>
                     ...
                     <div class="last-box">
                        <div class="Delivery">
                           <img src="{{asset('images/delivery.png')}}" style="width:50px">
                        </div>
                        <div class="last-text">
            ...
            <div class="row">
               ...
               <div class="kd-social">
                  <div class="login">
                     ...
                     <?php }else{?>
                        <a href="{{route('basketdetails.get')}}" class="basket" >My Basket
                            <input type="hidden" id="carttotal" value="{{$carttotal}}">
                        </a>
                     <?php }?>
         ...
         <div class="portfolist_sb_b" id="portfoliolist">
            <div class="row">
               ...
               <div class="portfolio {{$it->categoryitem->id}} col-md-6 burger w3-container  w3-animate-zoom portfoliocat" data-cat="{{$it->categoryitem->id}}" data-bound>
                  <div class="items">
                     <div class="b-img">
                        <a href="{{url('detailitem/'.$it->id)}}"><img src="{{asset('upload/images/menu_item_icon/'.$it->menu_image)}}"></a>
                     </div>
                     <div class="bor">
                        <div class="b-text">
               ...
               <div class="col-md-6 text-box">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-5 col-sm-5 col-5 google">
                        <a href="{{ Session::get('playstore')}}" target="_blank"><img src="{{asset('images/Google-Play-icon.png')}}" class="img-fluid"></a>
                     </div>
                     @endif
                     @if($setting->have_appstore=='1')
                     <div class="col-md-5 col-sm-5 col-5 apple">
                        <a href="{{ Session::get('appstore')}}" target="_blank"><img src="{{asset('images/App-Store-icon.png')}}" class="img-fluid"></a>
                     </div>
                     @endif
                  </div>
         ...
         <div class="footer">
            ...
            <div class="right">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <h1>{{__('messages.copyright')}} © {{Session::get('current_year')}} wells. {{__('messages.f1')}}.</h1>
                     </div>
                     <div class="col-md-6 v-box">
                        <div class="v-img">
                           <a href="#"><img src="{{asset('images/v-1.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="{{asset('images/v-2.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="{{asset('images/v-3.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="{{asset('images/v-4.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="{{asset('images/v-5.png')}}"></a>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <script type="text/javascript" src="{{ asset('js/code.js').'?version=965326' }}"></script>


   <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
   <script type="text/javascript" src="{{ asset('demo/button.js')}}"></script>
