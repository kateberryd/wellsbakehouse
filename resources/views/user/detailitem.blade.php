...
<div class="container detail-section-2">
   <div class="row">
      ...
      <div class="col-lg-5 col-md-5 col-sm-6 col-12">
         <img src="{{asset('upload/images/menu_item_icon/'.$itemdetails->menu_image)}}" class="img-fluid detail-product-img" alt="{{__('messages.res_image')}}">
      </div>
            ...
            <div class="bor detail-related-tab">
               <div class="items">
                  <div class="b-img">
                     ...
                     <img src="{{asset('upload/images/menu_item_icon/'.$related_item[$i]->menu_image)}}" class="img-fluid">
                     </a>
                  </div>
                  <div class="bor">
                     <div class="b-text">
