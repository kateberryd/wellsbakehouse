                     ...
                     <div class="collapse {{$showsec}} " id="collapseTH">
                        <div class="cashswipe">
                           ...
                           <div class="check">
                              ...
                              <img id="pay3" onclick="changebutton('Stripe')" src="{{asset('images/2.png')}}"/>
                           </div>
                           @endif
                        </div>
                     </div>
         ...
         <div class="col-lg-4">
               ...
               <div class="cart-b-subtotal">
                  <div class="cart-bs-head">
                     ...
                     <?php $cartCollection = Cart::getContent();
                        ...
                        ?>
                     <p>{{Session::get("usercurrency")}}<span id="subtotal_order"><?php echo number_format($subtotal, 2, '.', '');?></span></p>
                  </div>
               </div>
               <input type="hidden" name="subtotalorder" id="subtotalorder" value="{{$subtotal}}">
               ...
               <div class="cart-b-subtotal">
                  <div class="cart-bs-head cart-bs-ftotal">
                     ...
                     <p>{{Session::get("usercurrency")}}<span id="finaltotal_order"><?php $total=
                        $subtotal+$charges;?> {{number_format($total, 2, '.', '')}}</span></p>
                  </div>
               </div>
            </div>
            ...
            <div class="cart-shipping-box cart-t">
               ...
               <div id="orderplacestrip">
                  <form action="{{url('basket-payment')}}" method="POST">
                     {{ csrf_field() }}
               ...
               <div id="orderplacepaypal">
                  <form action="{{url('basketPaymentPayPal')}}" method="POST">
                     {{ csrf_field() }}
