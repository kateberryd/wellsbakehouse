...
<html>
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="shortcut icon" href="{{asset('favicon.png')}}">
      ...
      <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
         ...
         <link rel="stylesheet" type="text/css" href="{{asset('css/style.css').'?version=232132'}}">
         @else
           <link rel="stylesheet" type="text/css" href="{{asset('css/rtl.css').'?version=56565'}}">
         @endif
                        ...
                        <div class="portfolio por-1 col-md-12 row">
                           ...
                           <div class="b-text">
                              <div class="box-spa">
                                 ...
                                 <p>{{$item->quantity}} <img src="{{asset('images/cross.png')}}"> {{Session::get("usercurrency").number_format($item->price, 2, '.', ',')}}
                                 </p>
                              </div>
                              <span class="price">
         ...
         <div class="footer">
            ...
            <div class="right">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <h1>{{__('messages.copyright')}} © {{Session::get('current_year')}} {{__('messages.wells')}}. {{__('messages.f1')}}.</h1>
                     </div>
                     <div class="col-md-6 v-box">
                        <div class="v-img">
                           <a ><img src="{{asset('images/v-1.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('images/v-2.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('images/v-3.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('images/v-4.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('images/v-5.png')}}"></a>
                        </div>
                     </div>
                  </div>
               </div>
  ...
  <script type="text/javascript" src="{{ asset('js/code.js') }}?v=2132132"></script>

   <script type="text/javascript" src="{{ asset('demo/button.js').'?version=1'}}"></script>
   <script src="{{ asset('demo/script.js').'?version=133' }}"></script>
