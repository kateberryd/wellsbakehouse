                           ...
                           <tr class="cart-box-items">
                              ...
                              <td class="cart-category-items">
                                <form action="{{route('basket.post')}}" method="post">
                                    <input type="hidden" value="{{$item->name}}" name="prod_name">
                                    <input type="hidden" value="{{$item->price}}" name="prod_price">
                                    <input type="hidden" value="{{$item->quantity}}" name="prod_qty">
                                    @foreach($allmenu as $ai)   
                                    @if($item->name==$ai->menu_name)
                                       <input type="hidden" value="{{$ai->menu_image}}" name="prod_image">
                                    @endif 
                                    @endforeach
