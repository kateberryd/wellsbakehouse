      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="{{url('dashboard')}}">Wells Bakery</a>
            ...
            <div class="header-menu">
               ...
               <div class="col-sm-1">
                  ...
                  <div class="user-area dropdown float-right">
                     ...
                     <img class="user-avatar rounded-circle" src="/upload/images/profile/admin.jpg" alt="{{__('messages.user_avtar')}}">
                     </a>
...
<input type="hidden" id="print_lang" value='{{__("messages.print")}}'>
      ...
      <script type="text/javascript" src="{{asset('js/admin.js').'?v=1365'}}"></script>
      @yield('footer')
   </body>
</html>