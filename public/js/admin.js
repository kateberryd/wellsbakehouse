...
function editmenu(id){
    $.ajax( {
         ...
         success: function( data ) {
           ...
           $('#image1').attr("src", $("#path_admin").val()+"/upload/images/menu_cat_icon/"+"/"+data.cat_icon);          
         }
        }); 
}
$(document).ready(function () {
...
function edititem(id){
   $.ajax( {
         ...
         success: function( data ) {
           ...
           $('#image1').attr("src", $("#path_admin").val()+"/upload/images/menu_item_icon"+"/"+data.menu_image);
   ...
   function savegeneralinfo(){
               ...
               function savesoicallogin(){
                ...
                function changepayment(val){
                    ...
                    if ($("#flutterwave_active").prop("checked")) {
                        var flutterwave_active=1;
                     }
                     else{
                        var flutterwave_active=0;
                     }
