...
Route::post("addBasket","BuyerBasketController@store")->name('basket.post');
Route::get("basketdetails","BuyerBasketController@basketdetails")->name('basketdetails.get');
Route::any("basket-checkout","BuyerBasketController@index")->name('basket.checkout');
Route::get("deletebasketitem/{id}","BuyerBasketController@delete")->name("deletebasketitem");
...
Route::post('/basket-payment', 'PaymentController@basketPayment');
Route::get('paywithpaypal', array('as' => 'paywithpaypal','uses' => 'PaypalController@payWithPaypal',));
Route::post('paypal', array('as' => 'paypal','uses' => 'PaypalController@postPaymentWithpaypal',));
Route::get('paypal', array('as' => 'status','uses' => 'PaypalController@getPaymentStatus',));
Route::post('basketPaymentPayPal', array('as' => 'paypal','uses' => 'PaypalController@postPaymentWithpaypalBasket',));
Route::get('basketPaymentPayPal', array('as' => 'status','uses' => 'PaypalController@getPaymentStatusBasket',));
});
//admin
