                     ...
                     <div class="collapse <?php echo e($showsec); ?> " id="collapseTH">
                        <div class="cashswipe">
                           <!-- <div class="radio check">
                              ...
                              <img id="pay1" onclick="changebutton('Cash')" src="<?php echo e(asset('images/5.png')); ?>"/>
                           </div> -->
                           <div class="radio check">
                              <input type="checkbox" name="order_payment_type" id="order_payment_type_1" value="Cash" onchange="changebutton(this.value)">
                              <img id="pay2" onclick="changebutton('flutter_wave')" src="<?php echo e(asset('images/3.png')); ?>"/>
                           </div>
                           ...
                           <div class="check">
                              ...
                              <img id="pay2" onclick="changebutton('Paypal')" src="<?php echo e(asset('images/1.png')); ?>"/>
                           </div>
                           <?php endif; ?>
                           ...
                           <div class="check">
                              ...
                              <img id="pay3" onclick="changebutton('Stripe')" src="<?php echo e(asset('images/2.png')); ?>"/>
                           </div>
                           <?php endif; ?>
                        </div>
                     </div>
         ...
         <div class="col-lg-4">
               ...
               <div class="cart-b-subtotal">
                  <div class="cart-bs-head">
                     ...
                     <?php $cartCollection = Cart::getContent();
                        ...
                        ?>
                     <p><?php echo e(Session::get("usercurrency")); ?><span id="subtotal_order"><?php echo number_format($subtotal, 2, '.', '');?></span></p>
                  </div>
               </div>
               <input type="hidden" name="subtotalorder" id="subtotalorder" value="<?php echo e($subtotal); ?>">
               ...
               <div class="cart-b-subtotal">
                  <div class="cart-bs-head cart-bs-ftotal">
                     ...
                     <p><?php echo e(Session::get("usercurrency")); ?><span id="finaltotal_order"><?php $total=
                        $subtotal+$charges;?> <?php echo e(number_format($total, 2, '.', '')); ?></span></p>
                  </div>
               </div>
            </div>
            ...
            <div class="cart-shipping-box cart-t">
               ...
               <div id="orderplacestrip">
                  <form action="<?php echo e(url('basket-payment')); ?>" method="POST">
               ...
               <div id="orderplacepaypal">
                  <form action="<?php echo e(url('basketPaymentPayPal')); ?>" method="POST">
                     <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('user.subindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catherine/Documents/projects/kingburger/resources/views/user/basket_checkout.blade.php ENDPATH**/ ?>