         ...
         <div class="card-body">
            <div class="row">
               <div class="col col-md-6">
                  <label class=" form-control-label"><?php echo e(__('messages.setyourpre')); ?></label>
               </div>
               <div class="col-12 col-md-6">
                  <p class="form-control-static">
                     <?php if($presence=="No"||$presence=="no"): ?>
                     <a href="<?php echo e(url('deliveryboy/changeattendace/Yes')); ?>"><i class="fa fa-toggle-off prefenceswitch" aria-hidden="true"></i></a>
                     <?php endif; ?>
                     <?php if($presence=="Yes"||$presence=="yes"): ?>
                     <a href="<?php echo e(url('deliveryboy/changeattendace/No')); ?>"><i class="fa fa-toggle-on prefenceswitch" aria-hidden="true" ></i></a>
                     <?php endif; ?>
                  </p>
               </div>
            </div>
...
<?php echo $__env->make('deliveryboy.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catherine/Documents/projects/kingburger/resources/views/deliveryboy/dashboard.blade.php ENDPATH**/ ?>