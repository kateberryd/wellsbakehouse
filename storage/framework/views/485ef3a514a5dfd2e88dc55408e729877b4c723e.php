...
<html>
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('favicon.png')); ?>">
      ...
      <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
         ...
         <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/style.css').'?version=232132'); ?>">
         <?php else: ?>
           <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/rtl.css').'?version=56565'); ?>">
         <?php endif; ?>
      ...
      <script type="text/javascript" src="<?php echo e(asset('js/code.js')); ?>"></script>
      <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
                        ...
                        <div class="portfolio por-1 col-md-12 row">
                              ...
                              <div class="b-img">
                                 <?php $__currentLoopData = $allmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <?php if($item->name==$ai->menu_name): ?>
                                     <img src="<?php echo e(asset('images/menu_item_icon/'.$ai->menu_image)); ?>" width="85px">
                                   <?php endif; ?>
                           ...
                           <div class="b-text">
                              <div class="box-spa">
                                 ...
                                 <p><?php echo e($item->quantity); ?> <img src="<?php echo e(asset('images/cross.png')); ?>"> <?php echo e(Session::get("usercurrency").number_format($item->price, 2, '.', '')); ?>
         ...
         <div class="footer">
            ...
            <div class="right">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <h1><?php echo e(__('messages.copyright')); ?> © <?php echo e(Session::get('current_year')); ?> <?php echo e(__('messages.wells')); ?>. <?php echo e(__('messages.f1')); ?>.</h1>
                     </div>
                     <div class="col-md-6 v-box">
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('images/v-1.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('images/v-2.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('images/v-3.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('images/v-4.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('images/v-5.png')); ?>"></a>
                        </div>
                     </div>
                  </div>
               </div>
  ...
  <script type="text/javascript" src="<?php echo e(asset('js/code.js')); ?>?v=2132132"></script>

   <script type="text/javascript" src="<?php echo e(asset('demo/button.js').'?version=1'); ?>"></script>
   <script src="<?php echo e(asset('demo/script.js').'?version=133'); ?>"></script>
  
</html><?php /**PATH /home/catherine/Desktop/kingburger/resources/views/user/subindex.blade.php ENDPATH**/ ?>