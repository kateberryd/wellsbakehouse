...
<html>
   ...
   <body>
            ...
            <div class="modal-content">
               ...
               <div class="container">
                  <div class="cart-modal col-md-8">
                           ...
                           <div class="b-text">
                              <div class="box-spa">
                                 ...
                                 <p><?php echo e($item->quantity); ?>
                                    ...
                                    <img src="<?php echo e(asset('images/cross.png')); ?>">
                     ...
                     <div class="last-box">
                        <div class="Delivery">
                           <img src="<?php echo e(asset('images/delivery.png')); ?>" style="width:50px">
                        </div>
                        <div class="last-text">
      ...
      <div class="modal model1my" id="myModal2" >
         <div class="modal-dialog modal-1">
            <?php $cartCollection = Cart::getContent(); 
               if($cartCollection->count()==0){?>
            <div class="empty-box">
      ...
      <div class="first-section landing-page">
         <div class="img">
         </div>
            ...
            <div class="row">
               ...
               <div class="kd-social">
                  <div class="login">
                     ...
                     <?php }else{?>
                        <a href="<?php echo e(route('basketdetails.get')); ?>" class="basket" >My Basket
                            <input type="hidden" id="carttotal" value="<?php echo e($carttotal); ?>">
                        </a>
                     <?php }?>
               ...
               <div class="kb-text-box">
                  <h1>Get Ready For A</h1>
                  <!-- <h2><?php echo e(__('messages.silderh2')); ?></h2> -->
                  <h2>Super Delicious Experience</h2>
                  <p>A beautiful combination of amazing taste and perfect touch of quality health pastries .</p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-12">
               <div class="row">
                  ...
                  <div class="col-md-6 about-text">
                     ...
                     <h5>BEST BAKEHOUSE FOR YOU AND YOUR FAMILY
                     </h5>
                     <p>
                        Wells bakehouse is your best option for a good coffee, pastries and bake requests. Make your oders today and begin enjoying best services and delicious meals.
                     </p>
                  </div>
               </div>
            </div>
         ...
         <div class="portfolist_sb_b" id="portfoliolist">
            <div class="row">
               ...
               <div class="portfolio <?php echo e($it->categoryitem->id); ?> col-md-6 burger w3-container  w3-animate-zoom portfoliocat" data-cat="<?php echo e($it->categoryitem->id); ?>" data-bound>
                  <div class="items">
                     <div class="b-img">
                        <a href="<?php echo e(url('detailitem/'.$it->id)); ?>"><img src="<?php echo e(asset('upload/images/menu_item_icon/'.$it->menu_image)); ?>"></a>
                     </div>
                     <div class="bor">
                        <div class="b-text">
               ...
               <div class="col-md-6 text-box">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-5 col-sm-5 col-5 google">
                        <a href="<?php echo e(Session::get('playstore')); ?>" target="_blank"><img src="<?php echo e(asset('images/Google-Play-icon.png')); ?>" class="img-fluid"></a>
                     </div>
                     <?php endif; ?>
                     <?php if($setting->have_appstore=='1'): ?>
                     <div class="col-md-5 col-sm-5 col-5 apple">
                        <a href="<?php echo e(Session::get('appstore')); ?>" target="_blank"><img src="<?php echo e(asset('images/App-Store-icon.png')); ?>" class="img-fluid"></a>
                     </div>
                     <?php endif; ?>
                  </div>
         ...
         <div class="footer">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 info">
                     ...
                     <div class="f-location">
                        <img src="<?php echo e(asset('images/location.png')); ?>">
                     </div>
                     <span>
                     ...
                     <div class="f-location">
                        <img src="<?php echo e(asset('images/email.png')); ?>">
                     </div>
                     <span>
            ...
            <div class="right">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <h1><?php echo e(__('messages.copyright')); ?> © <?php echo e(Session::get('current_year')); ?> wells. <?php echo e(__('messages.f1')); ?>.</h1>
                     </div>
                     <div class="col-md-6 v-box">
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('images/v-1.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('images/v-2.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('images/v-3.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('images/v-4.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('images/v-5.png')); ?>"></a>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <script type="text/javascript" src="<?php echo e(asset('js/code.js').'?version=965326'); ?>"></script>


   <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
   <script type="text/javascript" src="<?php echo e(asset('demo/button.js')); ?>"></script>
   <script src="<?php echo e(asset('demo/script.js')); ?>"></script>
...
</html><?php /**PATH /home/catherine/Documents/projects/kingburger/resources/views/user/index.blade.php ENDPATH**/ ?>