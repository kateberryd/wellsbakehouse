<style type="text/css">
   ...
   .first-section .img{
        background-image:   linear-gradient(to bottom, rgb(49, 123, 139), rgba(117, 19, 93, 0.73)), url(<?=Session::get("main_banner")?>) !important;
   ...
   .secound-section {
      background-image: url(<?=Session::get("second_sec_img")?>) !important;
...
</style><?php /**PATH /home/catherine/Desktop/UploadingContentV1.3/kingburger/new_king_script_web/kingburger/resources/views/user/cssclass.blade.php ENDPATH**/ ?>