               ...
               <div class="cart-category">
                  <div class="row">
                     <table class="table table-image table-striped">
                        <thead class="cart-quantity-heading" style="padding-right: 200px; padding-left: 300px;">
                           <tr class="cart-category-head">
                              ...
                              <?php else: ?>
                              <th scope="col" class="cart-category-tab">Add to Basket <br> <i>(for easy checkout)</i></th>
                              <?php endif; ?>
                              <th scope="col" class="cart-category-tab">
                        ...
                        <tbody>
                           ...
                           <tr class="cart-box-items">
                              ...
                              <td class="cart-category-items">
                                <form action="<?php echo e(route('basket.post')); ?>" method="post">
                                    <input type="hidden" value="<?php echo e($item->name); ?>" name="prod_name">
                                    <input type="hidden" value="<?php echo e($item->price); ?>" name="prod_price">
                                    <input type="hidden" value="<?php echo e($item->quantity); ?>" name="prod_qty">
                                    <?php $__currentLoopData = $allmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                                    <?php if($item->name==$ai->menu_name): ?>
                                       <input type="hidden" value="<?php echo e($ai->menu_image); ?>" name="prod_image">
                                    <?php endif; ?> 
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  
                                    <button type="submit" class="add_basket">Add To Basket</button>
...
<?php echo $__env->make('user.subindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catherine/Documents/projects/kingburger/resources/views/user/cartdetails.blade.php ENDPATH**/ ?>