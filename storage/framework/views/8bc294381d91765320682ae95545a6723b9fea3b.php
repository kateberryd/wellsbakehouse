      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?php echo e(url('dashboard')); ?>">Wells Bakery</a>
            ...
            <div class="header-menu">
               ...
               <div class="col-sm-1">
                  ...
                  <div class="user-area dropdown float-right">
                     ...
                     <img class="user-avatar rounded-circle" src="/upload/images/profile/admin.jpg" alt="<?php echo e(__('messages.user_avtar')); ?>">
                     </a>
...
<input type="hidden" id="print_lang" value='<?php echo e(__("messages.print")); ?>'>
      ...
      <script type="text/javascript" src="<?php echo e(asset('js/admin.js').'?v=1365'); ?>"></script>
      <?php echo $__env->yieldContent('footer'); ?>
   </body>
</html><?php /**PATH /home/catherine/Desktop/UploadingContentV1.3/kingburger/new_king_script_web/kingburger/resources/views/admin/index.blade.php ENDPATH**/ ?>